      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row md:space-x-6">
          ...
          <div
            ...
            } bg-[rgba(15,23,42,0.35)] border border-[#0F172A] rounded-[12px] p-6 mb-6 md:mb-0 flex flex-col items-left text-left`}
          >
            ...
            <p className="text-[#d6d6d6] text-sm">
              Customise the questions that matter most to your business. You choose exactly what
              feedback you want from your customers.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-[#d6d6d6] text-sm">
              Customers scan a QR code and rate four simple questions on a scale of 1 to 5. It is
              fast, easy, and takes less than 20 seconds.
            </p>
          </div>
          ...
          <div
            ...
            } bg-[rgba(15,23,42,0.35)] border border-[#0F172A] rounded-[12px] p-6 flex flex-col items-left text-left`}
          >
            <div className="bg-[rgba(19,31,58,0.47)] p-2 rounded-[12px] mb-4 w-[fit-content]">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"  className="h-10 w-10 text-white"
            ...
            <p className="text-[#d6d6d6] text-sm">
              Revue transforms responses into authentic, compelling reviews and posts them on major
              platforms, boosting your online presence with minimal effort
            </p>
          </div>
        </div>
      </div>
